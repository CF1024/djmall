...
<script type="text/javascript">
    ...
    function cancelOrder() {
        ...
        token_post(
            "<%=request.getContextPath()%>/order/cancelOrder?TOKEN="+getToken(),
            $("#fm").serialize(),
            function (data) {
                layer.close(index);
                if(data.code !== 200){
...
<form id="fm">
    ...
    <div  id="hiddenCheck">
        ...
        <input type="checkbox" name="checked" <c:if test="${cart.checked == 2}">checked</c:if> value="${cart.cartId}" onclick="getTotal()">
    </div>
</form>
<div class="layui-form-item">
